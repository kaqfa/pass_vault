"""
Base Django settings for Pass-Man Enterprise Password Management System.
...
- SRS.md: Section 4 Non-Functional Requirements
- ARCHITECTURE.md: Django Configuration section
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='passmandb'),
        'USER': config('DB_USER', default='postgres'),
        'PASSWORD': config('DB_PASSWORD', default='postgres'),
        'HOST': config('DB_HOST', default='localhost'),
        'PORT': config('DB_PORT', default='5432'),
        'OPTIONS': {
            # Removed 'charset': 'utf8' as it's invalid for PostgreSQL
        },
        'TEST': {
            'NAME': 'test_passmandb',
        }
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@passmanager.com')
